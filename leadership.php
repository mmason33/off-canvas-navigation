...
<div class="container-fluid">
  ...
  <div class="col-lg-9 col-md-9 col-sm-9 hidden-xs-down">
    <div class="leadership-bio">
      ...
      <p>Over the last 20 years, Dustin has worked in several clinical and business development roles within the behavioral healthcare field. He started his career as a case manager in 1999 and has since worked as an Admissions Director, Program Director and Director of Marketing and Business Development.</p>
      <p>Throughout his career, Dustin has managed several large-scale projects, including rebranding, brand development and operational restructuring. He has also helped with developing church-based recovery programs and non-profits that provide mental health and addiction treatment for military and low-income families.</p>
      <p>Dustin currently oversees our marketing projects, admissions, public relations and utilization review. His unique perspective, extensive experience and passion for recovery serve as a priceless asset to Northbound. He currently resides in Tustin, California with his wife and three children.</p>
  </div>
  </div>
  <div class="col-lg-3 col-md-3 col-sm-3 leadership-image text-lg-right">
  ...
  <div class="col-lg-9 col-md-9 col-sm-9 hidden-xs-down">
    <div class="leadership-bio">
      <h3>Emily Bielen</h3>
      <h4>Vice President of Referral Relations</h4>
      <p>Emily has returned to Northbound as the Director of Referral Relations after a year as an independent behavioral healthcare consultant. She entered the behavioral healthcare industry as an academic director for two programs, including Northbound’s Collegebound, where she designed and implemented unique academic curriculum for clients to engage in their educational journey while in treatment. In her most recent role at Northbound, Emily helped to develop the Referral Relations team and looks forward to working with them again. Emily’s work as both an academic program director and a marketing manager within the addiction treatment industry prompted her to start a marketing consulting and academic advising practice. Emily has extensive experience in marketing and finance in both the private and public sector and brings to Northbound a comprehensive skill set. She attended Colgate University and New York University and went on to graduate school at Columbia University School of Social Work. Her educational background and personal journey in recovery motivates her to collaborate with programs and individuals to expand the opportunities available to clients of all ages and walks of life. Emily is also the mother of four children and enjoys spending time with her growing family.</p>
    </div>
  </div>
  </div>
</div>
